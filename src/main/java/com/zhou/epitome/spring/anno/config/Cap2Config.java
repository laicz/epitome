...
import com.zhou.epitome.spring.anno.cust_filter.MyCustomeFilterType;
...
//使用自定义TypeFilter
@ComponentScan(basePackages = "com.zhou.epitome.spring.anno", includeFilters = {@ComponentScan.Filter(type = FilterType.CUSTOM, value = MyCustomeFilterType.class)}, useDefaultFilters = false)
